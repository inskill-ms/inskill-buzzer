...
class InskillBuzzer_Install {
    ...
    public static function install() {
        ...
        // Tableau des noms de tables pour chaque mode
        $table_names = array(
        ...
        foreach ( $table_names as $table_name ) {
            ...
            } elseif ( strpos( $table_name, 'mode2_scores' ) !== false || strpos( $table_name, 'mode4_scores' ) !== false ) {
    ...
    public static function uninstall() {
        // Supprimer les options utilisées par le plugin pour chaque mode
        $options = array(
