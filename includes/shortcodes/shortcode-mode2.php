...
class InskillBuzzer_Shortcodes_Mode2 extends InskillBuzzer_Shortcodes {
    ...
    public function render_mode2_participant($atts) {
        ...
        <div class="participant-container">
            ...
            <!-- Suppression du bouton "Supprimer tous les participants" dans l'interface participant -->
        </div>
        <script>
    ...
    public function render_mode2_animateur($atts) {
        ...
        <div class="animateur-container">
            ...
            <div>
                <!-- Ajout d'un espacement plus grand au-dessus du titre "Participants connectés" -->
        ...
        function updateParticipantsList() {
            ...
            .then(data => {
                if(data.success) {
                    ...
                    // Ajout d'un margin-top sur le titre "Participants connectés"
