...
class InskillBuzzer_Shortcodes_Mode3 extends InskillBuzzer_Shortcodes {
    ...
    public function render_mode3_participant($atts) {
        ...
        table.participant-ranking-table {
            ...
            margin-top: 30px; /* Augmentation de l'espacement avec le titre "Classement" */
        }
        ...
        <div class="participant-container">
            ...
            <div id="scoreboard_mode3" style="display:none;">
                <h3 style="text-align:left; margin-top:30px;">Classement</h3>
            </div>
        </div>
        <script>
        ...
        document.addEventListener('DOMContentLoaded', function(){
            ...
            function updateRankingParticipant() {
                ...
                .then(data => {
                    if(data.success) {
                        ...
                        document.getElementById('scoreboard_mode3').innerHTML = '<h3 style="text-align:left; margin-top:30px;">Classement</h3>' + html;
            ...
            // Réactivation des boutons réponses en cas de réinitialisation (via le transient)
    ...
    public function render_mode3_animateur($atts) {
        ...
        /* Titre sur 3 lignes avec la 2ème ligne entre guillemets */
                    ...
                    if(data.success) {
                        ...
                        if(top3.length > 0) {
                            ...
                            top3.forEach(function(item, index) {
                                html += '<tr><td>' + (index+1) + '</td><td>' + item.participant_name + '</td><td>' + (item.answer ? item.answer : '-') + '</td></tr>';
                            });
                            html += '</table>';
                        } else {
