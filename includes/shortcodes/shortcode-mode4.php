...
class InskillBuzzer_Shortcodes_Mode4 extends InskillBuzzer_Shortcodes {
    ...
    public function render_mode4_participant($atts) {
        ...
        <div class="participant-container">
            ...
            <div id="scoreboard_mode4" style="display:none;">
                <h3 style="margin-top:30px;">Classement des équipes</h3>
        ...
        document.addEventListener('DOMContentLoaded', function(){
            ...
            // Polling pour réactiver les boutons réponses si le transient est réinitialisé
            setInterval(function(){
                // Si l'animateur a déclenché la réinitialisation, vérification du flag dans le localStorage
                if(localStorage.getItem('forceReset') === "true"){
                    answerButtons.forEach(function(btn){
                        btn.disabled = false;
    ...
    public function render_mode4_animateur($atts) {
        ...
        <div class="animateur-container">
            ...
            <div>
                <h3 style="text-align:left; margin-top:30px;">Résultats</h3>
            ...
            <div>
                <h3 style="text-align:left; margin-top:30px;">Participants connectés</h3>
                ...
                resetAnswersBtn.addEventListener('click', function(){
                    ...
                    .then(data => {
                        if(data.success){
                            ...
                            // Signaler aux participants de réinitialiser leurs boutons réponses
