    ...
    public function render_mode3_form() {
        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label for="inskill_buzzer_mode3_frontend_animateur_url">URL de la page frontend animateur (Quiz)</label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="inskill_buzzer_mode3_frontend_participant_url">URL de la page frontend participant (Quiz)</label></th>
                    <td>
